<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$config['grocery_crud_file_upload_allow_file_types'] 		= 'zip|gif|jpeg|jpg|png|tiff|doc|docx|txt|odt|xls|xlsx|pdf|ppt|pptx|pps|ppsx|mp3|m4a|ogg|wav|mp4|m4v|mov|wmv|flv|avi|mpg|ogv|3gp|3g2';
	...
	$config['grocery_crud_paging_options'] = array('10','15','20','25','50','100');
