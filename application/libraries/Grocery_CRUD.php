...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public function add_action_peru( $label, $image_url = '', $link_url = '', $css_class = '', $url_callback = null)
	{
		$unique_id_peru = substr($label,0,1).substr(md5($label.$link_url),-8); //The unique id is used for class name so it must begin with a string

		$this->actions_peru[$unique_id_peru]  = (object)array(
			'label_peru' 		=> $label,
			'image_url_peru' 	=> $image_url,
			'link_url_peru'		=> $link_url,
			'css_class_peru' 	=> $css_class,
			'url_callback_peru' => $url_callback,
			'url_has_http_peru'	=> substr($link_url,0,7) == 'http://' || substr($link_url,0,8) == 'https://' ? true : false
		);
