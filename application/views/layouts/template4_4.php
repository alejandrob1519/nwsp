...
<script type="text/javascript" src="<?php echo base_url()?>assets/js/funcionesChikungunya.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/js/chikungunya.js"></script>
...
<div class="barra">
        ...
        if($faltan <= 30){
            ...
            $termina = "&nbsp;Vigilancia de Fiebre por Virus Chikungunya | Versi&oacute;n Beta - 1";
        }
...
<header>
	...
	<?php
        include_once("public/menu/chikungunya_menu.php");
    ?>
    </div>
</header>
