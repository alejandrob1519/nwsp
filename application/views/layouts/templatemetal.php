...
function abrirVentana(){ 
   ...
   window.showModalDialog("modulosmetal/listarGrillaBrotesmetal",window,"dialogHeight:300px;dialogWidth:800px;center:yes;help:no;resizable:no;status:yes");   
} 
</script>
</head>
...
<div class="header">
	...
	<div class="titulo"><p>Intoxicaci&oacute;n por Metales Pesados</p></div>
</div>
<div class="container">
    ...
    <div class="sidebar">
        <?php
            include_once("public/menu/metales_menu.php");
        ?>
    </div>
