...
<div class="loginNotiWeb">
    ...
    <tr>
    <td width="50%" align="center"><h2><b>Emitir el Reporte de Notificaci&oacute;n</b></h2></td>
    ...
    $anio[''] = "Seleccione...";
    echo form_dropdown('anio', $anio, date("Y"), 'id="anio" style="width: 120px;"');?>
    </td></tr>
    <tr><td><strong>&nbsp;Semana:</strong></td>
    <td align="left">
	<?php echo form_error('semana', '<div class="warning">', '</div>'); 
    $semana[''] = "Seleccione...";
    echo form_dropdown('semana', $semana, date("W")-1, 'id="semana" style="width: 120px;"');?>
    </td></tr>
