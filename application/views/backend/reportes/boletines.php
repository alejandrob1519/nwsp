<?php
/******************************************************  
*   GENERADOR DEL REPORTE DE TABLAS PARA EL BOLETIN   *
*******************************************************/
...
<div class="loginNotiWeb">
    ...
    <tr>
    <td width="50%" align="center"><h2><b>Reporte de Tablas para el Bolet&iacute;n</b></h2></td>
    ...
    $semana[''] = "Seleccione...";
    echo form_dropdown('semana', $semana, date("W")-2, 'id="semana" style="width: 160px;"');?>
    </td></tr>
    <tr><td colspan="2">&nbsp;</td></tr> 
    <tr><td colspan="2"><hr /></td></tr>
    <tr>
    <td colspan="2" align="center">
    <input type="submit" id="botonCargando" name="aceptar" value="Aceptar" />
