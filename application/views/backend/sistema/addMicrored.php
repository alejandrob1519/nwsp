...
<div class="formulario1">
    <center><h2>Registro de Microredes de Salud</h2></center>
	<div style="border: solid 1px #000; width: 100%;">
		<table width="100%" align="center">
			...
			<tr>
              ...
              <input name="codigo" type="text" id="codigo" title="Ingrese el c&oacute;digo de la microred" value="<?php echo set_value('codigo')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="30" /></td>
		  </tr>
			<tr>  
				<td height="37"><strong>Nombre:</strong></td>
				<td>
				<?php echo form_error('nombre', '<div class="warning">', '</div>'); ?> 
				<input name="nombre" type="text" id="nombre" title="Ingrese el nombre de la microred" value="<?php echo set_value('nombre')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size='30' />
				</td>
			</tr>
			<tr>  
