...
$redes[''] = "Seleccione...";
echo form_dropdown('redes', $redes, $modificar->red, 'id="redes" style="width: 200px;" tabindex="3"');
?>
</td>
<td valign="middle">
...
$establec[''] = "Seleccione...";
echo form_dropdown('establec', $establec, $modificar->e_salud, 'id="establec" style="width: 220px;" tabindex="5"');
?>
</td>
</tr>
<tr>
...
echo form_dropdown('sexo', $sexo, $modificar->sexo, 'id="sexo" style="width: 200px;" tabindex="12"');
?>
</td>
<td></td>
<td valign="middle">
...
<input name="direccion" type="text" id="direccion" title="Ingrese la direcci&oacute;n del paciente" value="<?php echo $modificar->direccion;?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size='66' tabindex="15" />
</td>
...
echo form_dropdown('zona', $zona, $modificar->tip_zona, 'id="zona" style="width: 150px;" tabindex="16"');
?>
</td>
</tr>
<tr>
...
<input type="button" id="botonSalir" name="salir" value="Salir" title="Retornar a la p&aacute;gina principal" onclick="window.location='<?php echo site_url('backend/calidad/individualInconsistencias'); ?>'" />
