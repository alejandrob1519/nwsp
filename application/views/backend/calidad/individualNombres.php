...
<div style="position:absolute; font-size:10px; width:20%; margin-top: 28px; z-index: 1000;">
	<a class="btn btn-default btn-xs" href="<?php echo site_url('backend/calidad');?>" role="button"><span class="glyphicon glyphicon-backward"></span>&nbsp;Retorna al anterior</a>
</div>
...
<div id="tmm-form-wizard">
	...
	?>
        <div class="prev">
        	<button class="button button-control" type="button" id="atras" onClick="window.location.href='<?php echo site_url("backend/calidad/individualEstablecimientos"); ?>'"><span>Paso Anterior <b>Establecimientos</b></span></button>
            <div class="button-divider"></div>
        </div>
    
        <div class="next">
            <button class="button button-control display: none;" type="button" id="siguiente" onClick="window.location.href='<?php echo site_url("backend/calidad/individualEstablecimientos"); ?>'"><span>Siguiente Paso <b>Establecimientos</b></span></button>
            <div class="button-divider"></div>
        </div>
