...
echo form_dropdown('subetnias', $subetnias, $modificar->etnias, 'id="subetnias" style="width: 140px;" tabindex="4"');
?>
</td>
<td>
...
$redes[''] = "Seleccione...";
echo form_dropdown('redes', $redes, $modificar->red, 'id="redes" style="width: 140px;" tabindex="7"');
?>
</td>
...
$establec[''] = "Seleccione...";
echo form_dropdown('establec', $establec, $modificar->e_salud, 'id="establec" style="width: 140px;" tabindex="9"');
?>
</td>
</tr>
<tr>
...
echo form_dropdown('provincia', $provincia, substr( $modificar->ubigeo,0,4), 'id="provincia" style="width: 140px;" tabindex="11"');
?>
</td>
...
<input type="button" id="botonSalir" name="salir" value="Salir" title="Retornar a la p&aacute;gina principal" onclick="window.location='<?php echo site_url('backend/calidad'); ?>'" />
