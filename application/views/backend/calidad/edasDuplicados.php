...
<div id="tmm-form-wizard">
	...
	?>
        <div class="prev">
        	<button class="button button-control" type="button" id="atras" onClick="window.location.href='<?php echo site_url("backend/calidad/edasCalidad"); ?>'"><span>Paso Anterior <b>Semanas</b></span></button>
            <div class="button-divider"></div>
        </div>
    
        <div class="next">
            <button class="button button-control" type="button" id="siguiente" onClick="window.location.href='<?php echo site_url("backend/calidad/edasSemanas"); ?>'"><span>Siguiente Paso <b>Semanas</b></span></button>
            <div class="button-divider"></div>
        </div>
