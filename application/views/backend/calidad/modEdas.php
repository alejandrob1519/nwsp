...
$etnias[''] = "Seleccione...";
echo form_dropdown('etnias', $etnias, $modificar->etniaproc, 'id="etnias" style="width: 140px;" tabindex="3"');
?>
</td>
<td valign="middle">
<?php echo form_error('subetnias', '<div class="warning">', '</div>'); 
$subetnias[''] = "Seleccione...";
echo form_dropdown('subetnias', $subetnias, $modificar->etnias, 'id="subetnias" style="width: 150px;" tabindex="4"');
?>
</td>
<td>
...
echo form_dropdown('zona', $zona, $modificar->procede, 'id="zona" style="width: 140px;" tabindex="5"');
?>
</td>
</tr>
<tr>
...
$diresa[''] = "Seleccione...";
echo form_dropdown('diresa', $diresa, $modificar->sub_reg_nt, 'id="diresa" style="width: 140px;" tabindex="6"');
?>
</td>
...
$redes[''] = "Seleccione...";
echo form_dropdown('redes', $redes, $modificar->red, 'id="redes" style="width: 150px;" tabindex="7"');
?>
</td>
...
$microred[''] = "Seleccione...";
echo form_dropdown('microred', $microred, $modificar->microred, 'id="microred" style="width: 140px;" tabindex="8"');
?>
</td>
...
$establec[''] = "Seleccione...";
echo form_dropdown('establec', $establec, $modificar->e_salud, 'id="establec" style="width: 130px;" tabindex="9"');
?>
</td>
</tr>
<tr>
...
echo form_dropdown('departamento', $departamento, substr($modificar->ubigeo,0,2), 'id="departamento" style="width: 140px;" tabindex="10"');
?>
</td>
...
echo form_dropdown('provincia', $provincia, substr($modificar->ubigeo,0,4), 'id="provincia" style="width: 150px;" tabindex="11"');
?>
</td>
...
$distrito[''] = "Seleccione...";
echo form_dropdown('distrito', $distrito, $modificar->ubigeo, 'id="distrito" style="width: 140px;" tabindex="12"');
?>
</td>
</tr>
</table>
...
<input type="button" id="botonSalir" name="salir" value="Salir" title="Retornar a la p&aacute;gina principal" onclick="window.location='<?php echo site_url('backend/calidad/edasDefunciones'); ?>'" />
