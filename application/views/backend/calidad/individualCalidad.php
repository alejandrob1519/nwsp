...
<div id="tmm-form-wizard">
	...
	?>
        ...
        <div class="next">
            <button class="button button-control" type="button" id="siguiente" onClick="window.location.href='<?php echo site_url("backend/calidad/individualDiagnostico"); ?>'"><span>Siguiente Paso <b>Diagn&oacute;sticos</b></span></button>
            <div class="button-divider"></div>
        </div>
