		...
		<table width="100%" align="center">
			<tr>
				...
				<td width="59%">
					...
					<input name="paterno" type="text" id="paterno" title="Ingrese el apellido paterno del usuario" value="<?php echo set_value('paterno')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" autofocus="autofocus" size="30" />
				</td>
			</tr>
			<tr>
			  <td bgcolor="#CCCCCC"><strong>Apellido Materno: </strong></td>
			  <td><?php echo form_error('materno', '<div class="warning">', '</div>'); ?>
              <input name="materno" type="text" id="materno" title="Ingrese el apellido materno del usuario" value="<?php echo set_value('materno')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="30" /></td>
		  </tr>
			<tr>
			  <td bgcolor="#CCCCCC"><strong>Nombres:</strong></td>
			  <td><?php echo form_error('nombres', '<div class="warning">', '</div>'); ?>
              <input name="nombres" type="text" id="nombres" title="Ingrese los nombres del usuario" value="<?php echo set_value('nombres')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="30" /></td>
		  </tr>
			<tr>  
			...
			<tr>
              ...
              <input name="telefono" type="text" id="telefono" title="Ingrese el tel&eacute;fono del usuario" value="<?php echo set_value('telefono')?>" /></td>
		  </tr>
			<tr>
			  <td bgcolor="#CCCCCC"><strong>M&oacute;bil: </strong></td>
			  <td><?php echo form_error('mobil', '<div class="warning">', '</div>'); ?>
              <input name="mobil" type="text" id="mobil" title="Ingrese el m&oacute;bil del usuario" value="<?php echo set_value('mobil')?>" /></td>
		  </tr>
			<tr>  
				<td bgcolor="#CCCCCC"><strong>Usuario: </strong></td>
				<td>
				<?php echo form_error('usuario', '<div class="warning">', '</div>'); ?> 
				<input name="usuario" type="text" id="usuario" title="Ingrese el c&oacute;digo del usuario" value="<?php echo set_value('usuario')?>" />
				</td>
			</tr>
			<tr>  
				<td bgcolor="#CCCCCC"><strong>
				...
				<input name="contrasena" type="password" id="contrasena" title="Ingrese la contrase&ntilde;a del usuario" value="<?php echo set_value('clave')?>" />
				</td>
			</tr>
			<tr>  
				<td bgcolor="#CCCCCC"><strong>
