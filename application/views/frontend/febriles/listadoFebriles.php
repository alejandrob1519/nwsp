...
<div class="formulario">
    <center><h3 style="background-color:#CEE3F6;">REGISTRO SEMANAL DE NOTIFICACION DE CASOS FEBRILES</h3></center>
	<?php
    ...
    <input type="button" id="botonAnadir" name="aceptar" value="A&ntilde;adir" title="Ingresar un nuevo registro" onclick="window.location='<?php echo site_url('febriles/regFebriles'); ?>'" />
    </td>
    </tr>
    </table>
	<?php
