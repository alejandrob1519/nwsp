<?php
/************************************************* 
*   MODIFICACION SEMANAL NOTIFICACION DE FEBRILES    *
**************************************************/
...
<input name="fecha_ate" type="text" id="fecha_ate" tabindex="3" title="Ingrese la fecha de atenci&oacute;n del registro" value="<?php echo $this->fechas_model->modificarFechas($modificar->fecha_ate)?>" size='27' placeholder='Ejm. dd-mm-YYYY' />
</td>
...
<input name="fecha_not" type="text" id="fecha_not" tabindex="4" title="Ingrese la fecha de notificaci&oacute;n del registro" value="<?php echo $this->fechas_model->modificarFechas($modificar->fecha_not)?>" size='27' placeholder='Ejm. dd-mm-YYYY' />
</td>
</tr>
<tr>
...
//$diresa[''] = "Seleccione...";
echo form_dropdown('diresa', $diresa, $modificar->sub_reg_nt, 'id="diresa" style="width: 160px;" tabindex="5"');
?>
</td>
...
//$redes[''] = "Seleccione...";
echo form_dropdown('redes', $redes, $modificar->red, 'id="redes" style="width: 200px;" tabindex="6"');
?>
</td>
...
//$microred[''] = "Seleccione...";
echo form_dropdown('microred', $microred, $modificar->microred, 'id="microred" style="width: 200px;" tabindex="7"');
?>
</td>
...
//$establec[''] = "Seleccione...";
echo form_dropdown('establec', $establec, $modificar->e_salud, 'id="establec" style="width: 200px;" tabindex="8"');
?>
</td>
</tr>
<tr>
...
echo form_dropdown('departamento', $departamento, substr($modificar->ubigeo,0,2), 'id="departamento" style="width: 160px;" tabindex="9"');
?>
</td>
...
echo form_dropdown('provincia', $provincia, substr($modificar->ubigeo,0,4), 'id="provincia" style="width: 200px;" tabindex="10"');
?>
</td>
...
$distrito[''] = "Seleccione...";
echo form_dropdown('distrito', $distrito, $modificar->ubigeo, 'id="distrito" style="width: 200px;" onchange="duplicadoFebriles();" tabindex="11"');
?>
</td>
</tr>
</table>
...
<input name="feb_m1" type="text" id="feb_m1" title="febriles en menores de < 1 a&ntilde;o" value="<?php echo $modificar->feb_m1?>" size='10' tabindex="12" onFocus="sumaFebriles()" />
</td>
<td align="center">
<?php echo form_error('feb_1_4', '<div class="warning">', '</div>'); ?> 
<input name="feb_1_4" type="text" id="feb_1_4" title="febriles en menores de 1 a 4 a&ntilde;os" value="<?php echo $modificar->feb_1_4?>" size='10' tabindex="14" onFocus="sumaFebriles()" />
</td>
<td align="center">
<?php echo form_error('feb_5_9', '<div class="warning">', '</div>'); ?> 
<input name="feb_5_9" type="text" id="feb_5_9" title="febriles de 5 a 9 a&ntilde;os" value="<?php echo $modificar->feb_5_9?>" size='10' tabindex="15" onFocus="sumaFebriles()" />
</td>
<td align="center">
<?php echo form_error('feb_10_19', '<div class="warning">', '</div>'); ?> 
<input name="feb_10_19" type="text" id="feb_10_19" title="febriles de 5 a 9 a&ntilde;os" value="<?php echo $modificar->feb_10_19?>" size='10' tabindex="16" onFocus="sumaFebriles()" />
</td>
<td align="center">
<?php echo form_error('feb_20_59', '<div class="warning">', '</div>'); ?> 
<input name="feb_20_59" type="text" id="feb_20_59" title="febriles de 20 a 59 a&ntilde;os" value="<?php echo $modificar->feb_20_59?>" size='10' tabindex="17" onFocus="sumaFebriles()" />
</td>
<td align="center">
<?php echo form_error('feb_m60', '<div class="warning">', '</div>'); ?> 
<input name="feb_m60" type="text" id="feb_m60" title="febriles en mayores de 60 a&ntilde;os" value="<?php echo $modificar->feb_m60?>" size='10' tabindex="18" onFocus="sumaFebriles()" />
</td>
<td align="center">
<?php echo form_error('feb_tot', '<div class="warning">', '</div>'); ?> 
<input name="feb_tot" type="text" id="feb_tot" title="Total de febriles" value="<?php echo $modificar->feb_tot?>" size='10' tabindex="19" onFocus="sumaFebriles()" />
</td>
</tr>
<tr>
<tr>
...
<input name="tot_aten" type="text" id="tot_aten" title="Total de atenciones en el EESS" value="<?php echo $modificar->tot_aten?>" size='10' tabindex="20" />
</td>
</tr>
<tr><td colspan="7" valign="middle"><hr/></td></tr>
<tr>
