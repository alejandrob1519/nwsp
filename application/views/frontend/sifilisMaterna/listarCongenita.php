...
<div class="formulario1">
	<?php
        if(isset($registro)){
            $datos = $this->fichas_model->mostrarSifilis($registro);
        }else{
            $registro = $this->input->post("regis", true);
            $datos = $this->fichas_model->mostrarSifilis($this->input->post("regis", true));
        }
    ?>
	...
	<div style="border: solid 1px #000; width: 100%;">
		<table width="100%" align="center">
			...
			if($datos->diagnostic == "A50"){
				...
				<tr>
					...
					<td>
					  <input name="madre_apenom" type="text" id="madre_apenom" title="Vienen del NotiWeb" value="<?php echo set_value('hijo_apenom')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="50" /></td>
				...
				<tr>
					...
					<td><?php echo form_error('hijo_apenom', '<div class="warning">', '</div>'); ?>
					  <input name="hijo_apenom" type="text" id="hijo_apenom" title="Registrar los apellidos y nombres del hijo (a)" value="<?php echo $datos->apepat." ".$datos->apemat." ".$datos->nombres;?>" size="50" readonly="readonly" /></td>
					<td colspan="2"><input name="codigo" type="text" id="codigo" title="Vienen del NotiWeb" value="<?php echo set_value('codigo')?>" size="15" /></td>
				</tr>
				<?php
			}else{
				?>
				<tr>
					<td><strong>Apellidos y nombres de la madre:</strong></td>
					<td>
					  <input name="madre_apenom" type="text" id="madre_apenom" title="Vienen del NotiWeb" value="<?php echo $datos->apepat." ".$datos->apemat." ".$datos->nombres;?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="50" readonly="readonly" /></td>
					<td colspan="2"><strong>Código (DNI Madre)</strong></td>
				</tr>
				<tr>
					<td><strong>Apellidos y nombres del hijo (a):</strong></td>
					<td><?php echo form_error('hijo_apenom', '<div class="warning">', '</div>'); ?>
					  <input name="hijo_apenom" type="text" id="hijo_apenom" title="Registrar los apellidos y nombres del hijo (a)" value="<?php echo set_value('hijo_apenom')?>" size="50" /></td>
					<td colspan="2">
					<?php	  
  				    if($datos->diagnostic == "O98.1"){
						?>
	                    <input name="codigo" type="text" id="codigo" title="Vienen del NotiWeb" value="<?php echo $datos->dni?>" size="15" /></td>
                        <?php
					}else{
						?>
	                    <input name="codigo" type="text" id="codigo" title="Vienen del NotiWeb" value="<?php echo set_value('codigo')?>" size="15" /></td>
                        <?php
					}
					?>
				</tr>
		    ...
		    <tr>
		      <td><strong>Establecimiento de Salud:</strong></td>
			   <td><input name="establecimiento" type="text" id="establecimiento" title="Vienen del NotiWeb" value="<?php echo $datos->raz_soc;?>" size="50" readonly="readonly" /></td>
			   <td colspan="2"><strong>Nivel de establecimiento</strong></td>
	      	</tr>
			<tr>
			   <td><strong>Instituci&oacute;n:</strong></td>
               <?php
			   switch(substr($datos->e_salud,6,1))
			   {
				   case 'A':
				   $institucion = 'MINSA';
				   break;
			   ...
			   ?>
			   <td><input name="insti" type="text" id="insti" title="Vienen del NotiWeb" value="<?php echo $institucion;?>" size="15" readonly="readonly" /></td>
			   <td colspan="2"><input name="categoria" type="text" id="categoria" title="Vienen del NotiWeb" value="<?php echo $datos->categoria;?>" size="15" readonly="readonly" /></td>
	      	</tr>
		    <tr>  
            ...
            <tr>
				<td><input name="subregion" type="text" id="subregion" title="Vienen del NotiWeb" value="<?php echo $datos->diresa;?>" size="25" readonly="readonly" /></td>
				<td><input name="red" type="text" id="red" title="Vienen del NotiWeb" value="<?php echo $datos->redes;?>" size="50" readonly="readonly" /></td>
				<td colspan="2"><input name="mred" type="text" id="mred" title="Vienen del NotiWeb" value="<?php echo $datos->microredes;?>" size="50" readonly="readonly" /></td>
          	</tr>
            <tr>
              <td><strong>Fecha de notificaci&oacute;n</strong></td>
              <td><strong>Semana epidemiol&oacute;gica</strong></td>
              <td><strong>Investigaci&oacute;n de:</strong></td>
            </tr>
            <tr>
              <td><?php echo form_error('fecha_not', '<div class="warning">', '</div>'); ?>
              <input name="fecha_not" type="text" id="fecha_not" title="Ingrese la fecha de investigaci&oacute;n" value="<?php echo $this->fechas_model->modificarFechas($datos->fecha_not);?>" size="15" readonly="readonly" /></td>
              <td><input name="semana" type="text" id="semana" title="Vienen del NotiWeb" value="<?php echo $datos->semana;?>" size="5" readonly="readonly" /></td>
              <td>
			  <?php echo form_error('sifilis1', '<div class="warning">', '</div>'); 
        ...
        if($datos->diagnostic != "A50"){
			?>
	        <div id='materna' style="display:block;">
            <?php
		}else{
			?>
	        <div id='materna' style="display:none;">
            <?php
		}
		?>
   		<table width="100%" align="center">
            ...
            <tr>
              ...
              <input name="fecha_nac" type="text" id="fecha_nac" title="Ingrese la fecha de nacimiento del paciente" value="<?php echo $this->input->post("fecha_nac", true);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td><input name="edad" type="text" id="edad" title="Vienen del NotiWeb" value="<?php echo $datos->edad;?>" size="5" readonly="readonly" /></td>
               <?php
            ...
            <tr>
              <td>
                ...
                echo form_dropdown('pais', $paises, '171', 'id="pais" style="width: 200px;"');
                ?>
              </td>
              <td>
                ...
                echo form_dropdown('departamento', $dep, null, 'id="departamento" style="width: 200px;"');
                ?>
              </td>
              <td>
                <?php echo form_error('provincia', '<div class="warning">', '</div>'); 
                $prov[''] = "Seleccione...";
                echo form_dropdown('provincia', $prov, null, 'id="provincia" style="width: 200px;"');
                ?>
              </td>
              <td>
                <?php echo form_error('distrito', '<div class="warning">', '</div>'); 
                $dist[''] = "Seleccione...";
                echo form_dropdown('distrito', $dist, null, 'id="distrito" style="width: 200px;"');
                ?>
              </td>
              <td><?php echo form_error('localidad', '<div class="warning">', '</div>'); ?>
              <input name="localidad" type="text" id="localidad" title="Ingrese la localidad donde habita el paciente" value="<?php echo set_value('localidad')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="40" /></td>
			</tr>              
			<tr>
			  <td colspan="5" bgcolor="#CCCCCC"><hr/></td>
	  	  	</tr>
            ...
            <tr>
              <td>
              <input name="fecha_ini" type="text" id="fecha_ini" title="Ingrese la fecha de inicio de &uacute;ltima mestruasi&oacute;n" value="<?php echo set_value('fecha_ini')?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td>
              <?php
			  if($this->input->post("desconocido_ini", true) == "on"){
				  ?>
				  <input name="desconocido_ini" type="checkbox" id="desconocido_ini" checked="checked" title="Desconoce la fecha de inicio de &uacute;ltima mestruasi&oacute;n" />&nbsp;&nbsp;<strong>Desconocido</strong></td>
				  <?php                  
			  }else{
				  ?>
				  <input name="desconocido_ini" type="checkbox" id="desconocido_ini" title="Desconoce la fecha de inicio de &uacute;ltima mestruasi&oacute;n" />&nbsp;&nbsp;<strong>Desconocido</strong></td>
				  <?php                  
			  }
			  ?>
              <td>
                <select name="atencion" id="atencion" title="Elija si la paciente recibi&oacute; atenci&oacute;n prenatal">
            ...
            <tr>
              <td><input name="fecha_con1" type="text" id="fecha_con1" title="Ingrese la fecha de primer control prenatal" value="<?php echo $this->input->post("fecha_con1", true);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td>
              <?php
			  if($this->input->post("desconocido_con1", true) == "on"){
				  ?>
	              <input name="desconocido_con1" type="checkbox" id="desconocido_con1" checked="checked" title="Desconoce la fecha de primer control prenatal" />&nbsp;&nbsp;<strong>Desconocido</strong></td>
				  <?php                  
			  }else{
				  ?>
	              <input name="desconocido_con1" type="checkbox" id="desconocido_con1" title="Desconoce la fecha de primer control prenatal" />&nbsp;&nbsp;<strong>Desconocido</strong></td>
				  <?php                  
			  }
			  ?>
              <td><input name="edad_ges" type="text" id="edad_ges" title="Ingrese edad gestacional" value="<?php echo $this->input->post("edad_ges", true);?>" size="5" /></td>            
            </tr>
			<tr>
			  <td colspan="5" bgcolor="#CCCCCC"><hr/></td>
	  	    </tr>
            ...
            <tr>
              ...
              <input name="fecha_ntrep1" type="text" id="fecha_ntrep1" title="Ingrese la fecha correspondiente" value="<?php echo set_value('resultados_ntrep1')?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td><?php echo form_error('resultados_ntrep1', '<div class="warning">', '</div>'); ?>
                <select name="resultados_ntrep1" id="resultados_ntrep1" title="Elija el resultado correspondiente">
                  <option value="">Selecione...</option>
              ...
              <input name="titulo_ntrep1" type="text" id="titulo_ntrep1" title="Ingrese los t&iacute;tulos de los resultados" value="<?php echo set_value('titulo_ntrep1')?>" size="30" onkeyup="javascript:this.value=this.value.toUpperCase();" /></td>            
              <td><?php echo form_error('momento_ntrep1', '<div class="warning">', '</div>'); ?>    
                <select name="momento_ntrep1" id="momento_ntrep1" title="Elija el momento correspondiente">
                  <option value="">Selecione...</option>
            ...
            <tr>
              ...
              <input name="fecha_ntrep2" type="text" id="fecha_ntrep2" title="Ingrese la fecha correspondiente" value="<?php echo set_value('resultados_ntrep2')?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td><?php echo form_error('resultados_ntrep2', '<div class="warning">', '</div>'); ?>
                <select name="resultados_ntrep2" id="resultados_ntrep2" title="Elija el resultado correspondiente">
                  <option value="">Selecione...</option>
              ...
              <input name="titulo_ntrep2" type="text" id="titulo_ntrep2" title="Ingrese los t&iacute;tulos de los resultados" value="<?php echo set_value('titulo_ntrep2')?>" size="30" onkeyup="javascript:this.value=this.value.toUpperCase();" /></td>            
              <td><?php echo form_error('momento_ntrep2', '<div class="warning">', '</div>'); ?>  
                <select name="momento_ntrep2" id="momento_ntrep2" title="Elija el momento correspondiente">
                  <option value="">Selecione...</option>
			...
			<tr>
			  <td colspan="5" align="justify"><strong>Indique las fechas y resultados de la primera (a) y la m&aacute;s reciente (b) prueba trepon&eacute;mica (TPHA, TPPA, FTA Abs, ELISA prueba r&aacute;pida o dual) realizada durante la gestaci&oacute;n, parto o puerperio.</strong></td>
		  	</tr>
			<tr>
			  <td colspan="5" bgcolor="#CCCCCC"><hr/></td>
	  	    </tr>
            ...
            <tr>
              ...
              <input name="fecha_trep1" type="text" id="fecha_trep1" title="Ingrese la fecha correspondiente" value="<?php echo set_value('resultados_trep1')?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td><?php echo form_error('tipo_trep1', '<div class="warning">', '</div>'); ?>
                <select name="tipo_trep1" id="tipo_trep1" title="Elija el tipo de prueba correspondiente">
                  <option value="">Selecione...</option>
                  <option value="1" <?php if($this->input->post("tipo_trep1", true) == "1"){?> selected="selected" <?php }?>>Prueba r&aacute;pida/ Prueba dual</option>
                  <option value="2" <?php if($this->input->post("tipo_trep1", true) == "2"){?> selected="selected" <?php }?>>R&aacute;pida</option>
                </select>
              </td>            
              <td><input name="otra_trep1" type="text" id="otra_trep1" title="Ingrese otra prueba" value="<?php echo $this->input->post("otra_trep1", true);?>" size="30" onkeyup="javascript:this.value=this.value.toUpperCase();" /></td>            
              <td><?php echo form_error('resultados_trep1', '<div class="warning">', '</div>'); ?>
                <select name="resultados_trep1" id="resultados_trep1" title="Elija el resultado correspondiente">
                  <option value="">Selecione...</option>
              ...
              <td><?php echo form_error('momento_trep1', '<div class="warning">', '</div>'); ?> 
                <select name="momento_trep1" id="momento_trep1" title="Elija el momento correspondiente">
                  <option value="">Selecione...</option>
            ...
            <tr>
              ...
              <input name="fecha_trep2" type="text" id="fecha_trep2" title="Ingrese la fecha correspondiente" value="<?php echo set_value('resultados_trep2')?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td><?php echo form_error('tipo_trep2', '<div class="warning">', '</div>'); ?>
                <select name="tipo_trep2" id="tipo_trep2" title="Elija el tipo de prueba correspondiente">
                  <option value="">Selecione...</option>
                  <option value="1" <?php if($this->input->post("tipo_trep2", true) == "1"){?> selected="selected" <?php }?>>Prueba r&aacute;pida/ Prueba dual</option>
                  <option value="2" <?php if($this->input->post("tipo_trep2", true) == "2"){?> selected="selected" <?php }?>>R&aacute;pida</option>
                </select>
              </td>            
              <td><input name="otra_trep2" type="text" id="otra_trep2" title="Ingrese otra prueba" value="<?php echo $this->input->post("otra_trep2", true);?>" size="30" onkeyup="javascript:this.value=this.value.toUpperCase();" /></td>            
              <td><?php echo form_error('resultados_trep2', '<div class="warning">', '</div>'); ?>
                <select name="resultados_trep2" id="resultados_trep2" title="Elija el resultado correspondiente">
                  <option value="">Selecione...</option>
              ...
              <td><?php echo form_error('momento_trep2', '<div class="warning">', '</div>'); ?>
                <select name="momento_trep2" id="momento_trep2" title="Elija el momento correspondiente">
                  <option value="">Selecione...</option>
            ...
            <tr>
              <td>
                <select name="tratamiento" id="tratamiento" title="Elija si tuvo tratamiento apropiado">
                  <option value="">Selecione...</option>
			  ...
			  if($this->input->post("motivo_no2", true) == "on"){
				  ?>
	              <input name="motivo_no2" type="checkbox" id="motivo_no2" checked="checked" title="Elija motivo" />&nbsp;&nbsp;<strong>Tratamiento durante los primeros 30 d&iacute;as previos</strong><br />
				  <?php                  
			  }else{
				  ?>
	              <input name="motivo_no2" type="checkbox" id="motivo_no2" title="Elija motivo" />&nbsp;&nbsp;<strong>Tratamiento durante los primeros 30 d&iacute;as previos</strong><br />
				  <?php                  
			  }
			  ?>
              <?php
			  if($this->input->post("motivo_no3", true) == "on"){
				  ?>
                  <input name="motivo_no3" type="checkbox" id="motivo_no3" checked="checked" title="Elija motivo" />&nbsp;&nbsp;<strong>No inicio tratamiento durante la gestaci&oacute;n</strong>
				  <?php                  
			  }else{
				  ?>
                  <input name="motivo_no3" type="checkbox" id="motivo_no3" title="Elija motivo" />&nbsp;&nbsp;<strong>No inicio tratamiento durante la gestaci&oacute;n</strong>
				  <?php                  
			  }
			  ?>
              </td>
              <td>
                <select name="contacto" id="contacto" title="Elija el resultado correspondiente">
                  <option value="">Selecione...</option>
              ...
              <td>
                <select name="estadio" id="estadio" title="Elija el momento correspondiente">
                  <option value="">Selecione...</option>
                  <option value="1" <?php if($this->input->post("estadio", true) == "1"){?> selected="selected" <?php }?>>S&iacute;filis primaria</option>
                  <option value="2" <?php if($this->input->post("estadio", true) == "2"){?> selected="selected" <?php }?>>S&iacute;filis secundaria</option>
                  <option value="3" <?php if($this->input->post("estadio", true) == "3"){?> selected="selected" <?php }?>>S&iacute;filis latente</option>
                  <option value="4" <?php if($this->input->post("estadio", true) == "4"){?> selected="selected" <?php }?>>Desconocido</option>
                </select>
              </td>            
            </tr>
			<tr>
		...
		?>
   		<table width="100%" align="center">
            ...
            <tr>
              ...
              <input name="fecha_par" type="text" id="fecha_par" title="Ingrese la fecha correspondiente" value="<?php echo set_value('fecha_par')?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td><?php echo form_error('diresa', '<div class="warning">', '</div>'); ?>
                ...
                echo form_dropdown('diresa', $subreg, null, 'id="diresa" style="width: 200px;"');
                ?>
              </td>
              ...
              <td><?php echo form_error('establec', '<div class="warning">', '</div>'); ?>
                <?php
                $est[''] = "Seleccione...";
                echo form_dropdown('establec', $est, null, 'id="establec" style="width: 200px;" onChange="nivelEstablecimiento();"');
                ?>
              </td>
              <td><?php echo form_error('estado_vital', '<div class="warning">', '</div>'); ?>
                <select name="estado_vital" id="estado_vital" title="Elija el momento correspondiente">
                  <option value="">Selecione...</option>
            ...
            <tr>
			  ...
			  ?>
              <td colspan="4"><strong>Nivel de establecimiento: </strong><input name="nivel_estab" type="text" id="nivel_estab" value="<?php echo $this->input->post("nivel_estab", true);?>" size="30" /></td>
            </tr>
            <tr>
              <td></td>
              <td>
            ...
            <tr>
              <td><strong>Fecha de fallecimiento: </strong><input name="fecha_fac" type="text" id="fecha_fac" title="Ingrese la fecha correspondiente" value="<?php echo $this->input->post("fecha_fac", true);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td colspan="2"><strong>Peso al nacimiento: </strong><input name="peso_nac" type="text" id="peso_nac" title="Ingrese el peso al nacer" value="<?php echo $this->input->post("peso_nac", true);?>" size="5" /><strong> gramos</strong></td>            
              <td colspan="2"><strong>Edad gestacional estimada: </strong><input name="edad_ges" type="text" id="edad_ges" title="Ingrese la edad gestacional" value="<?php echo $this->input->post("edad_ges", true);?>" size="5" /><strong> semanas</strong></td>            
            </tr>
            <tr>
              <td>
              <?php
            ...
            <tr>
              <td><strong>Fecha de los test: </strong>&nbsp;&nbsp;<input name="fecha_test" type="text" id="fecha_test" title="Ingrese la fecha correspondiente" value="<?php echo $this->input->post("fecha_test", true);?>" size="12" placeholder="Ej. dd-mm-YYYY" /></td>
              <td>
              <?php
			  ...
			  ?>
              <td colspan="2"><strong>T&iacute;tulo de la madre:</strong>&nbsp;&nbsp;<input name="titulo_madre" type="text" id="titulo_madre" title="Ingrese los t&iacute;tulos de la madre" value="<?php echo $this->input->post("titulo_madre", true);?>" size="20" /></td>
              <td colspan="2"><strong>T&iacute;tulo del ni&ntilde;o:</strong>&nbsp;&nbsp;<input name="titulo_hijo" type="text" id="titulo_hijo" title="Ingrese los t&iacute;tulos del ni&ntilde;o" value="<?php echo $this->input->post("titulo_hijo", true);?>" size="20" /></td>
            </tr>
            <tr>
              <td colspan="6">
              <?php
            ...
            <tr>
			  ...
			  if($this->input->post("criterio5", true) == "on"){
				  ?>
	              <input name="criterio5" type="checkbox" id="criterio5" checked="checked" title="Elija de ser el caso" />&nbsp;&nbsp;<strong>Ni&ntilde;o mayor de dos a&ntilde;os de edad, con signos cl&iacute;nicos de s&iacute;filis secundaria en el que se ha descartado el antecedente de abuso sexual o contacto sexual.</strong></td>
				  <?php                  
			  }else{
				  ?>
	              <input name="criterio5" type="checkbox" id="criterio5" title="Elija de ser el caso" />&nbsp;&nbsp;<strong>Ni&ntilde;o mayor de dos a&ntilde;os de edad, con signos cl&iacute;nicos de s&iacute;filis secundaria en el que se ha descartado el antecedente de abuso sexual o contacto sexual.</strong></td>
				  <?php                  
			  }
			  ?>
            </tr>
            ...
            <tr>
              <td colspan="3">
                <select name="tratado" id="tratado" title="Elija el momento correspondiente">
                  <option value="">Selecione...</option>
                  <option value="1" <?php if($this->input->post("tratado", true) == "1"){?> selected="selected" <?php }?>>Si, con penicilina acuosa o procainica por >= 10 d&iacute;as</option>
              ...
              <td colspan="3">
                <select name="clasificacion" id="clasificacion" title="Elija el momento correspondiente">
                  <option value="">Selecione...</option>
        ...
        <table width="100%" align="center">
            ...
            <strong>Nombres y apellidos del notificador:</strong>&nbsp;&nbsp;<input name="notificador" type="text" id="notificador" title="apellidos y nombres del responsable de la notificaci&oacute;n" value="<?php echo set_value('notificador')?>" size="50" onkeyup="javascript:this.value=this.value.toUpperCase();" /></td>
            </tr>
			<tr>
			  <td><hr/></td>
	  	    </tr>
            <tr>
			  <td align="right">
				...
				<input type="button" id="botonGrabar" name="enviar" value="&nbsp;&nbsp;&nbsp;Grabar" onclick="submit();" />
