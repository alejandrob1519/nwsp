		...
		?>
   		<table width="100%" align="center">
            ...
            <tr>
			  ...
			  ?>
              <td colspan="4"><strong>Nivel de establecimiento: </strong>
			  <input name="nivel_estab" type="text" id="nivel_estab" value="<?php echo $this->input->post("nivel_estab", true);?>" size="30" />
			  </td>
            </tr>
            <tr>
              <td></td>
