        ...
        <div id='materna'>
   		<table width="100%" align="center">
            ...
            <tr>
              ...
              <input name="fecha_nac" type="text" id="fecha_nac" title="Ingrese la fecha de nacimiento del paciente" value="<?php echo $this->fechas_model->modificarFechas($modificar1->fecha_nac);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
            ...
            <tr>
              <td>
                ...
                echo form_dropdown('pais', $paises, $modificar1->pais, 'id="pais" style="width: 200px;"');
                ?>
              </td>
              <td>
                ...
                echo form_dropdown('departamento', $dep, substr($modificar1->residencia,0,2), 'id="departamento" style="width: 200px;"');
                ?>
              </td>
              <td>
                <?php echo form_error('provincia', '<div class="warning">', '</div>'); 
                $prov[''] = "Seleccione...";
                echo form_dropdown('provincia', $prov, substr($modificar1->residencia,0,4), 'id="provincia" style="width: 200px;"');
                ?>
              </td>
              <td>
                <?php echo form_error('distrito', '<div class="warning">', '</div>'); 
                $dist[''] = "Seleccione...";
                echo form_dropdown('distrito', $dist, $modificar1->residencia, 'id="distrito" style="width: 200px;"');
                ?>
              </td>
              <td><?php echo form_error('localidad', '<div class="warning">', '</div>'); ?>
              <input name="localidad" type="text" id="localidad" title="Ingrese la localidad donde habita el paciente" value="<?php echo $modificar1->localidad;?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="40" /></td>
			</tr>              
			<tr>
			  <td colspan="5" bgcolor="#CCCCCC"><hr/></td>
	  	  	</tr>
            ...
            <tr>
              <td>
              <input name="fecha_ini" type="text" id="fecha_ini" title="Ingrese la fecha de inicio de &uacute;ltima mestruasi&oacute;n" value="<?php echo $this->fechas_model->modificarFechas($modificar1->fecha_ini);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td>
              <?php
            ...
            <tr>
              <td><input name="fecha_con1" type="text" id="fecha_con1" title="Ingrese la fecha de primer control prenatal" value="<?php echo $this->fechas_model->modificarFechas($modificar1->fecha_con1);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td>
              <?php
			  ...
			  ?>
              <td><input name="edad_ges" type="text" id="edad_ges" title="Ingrese edad gestacional" value="<?php echo $modificar1->edad_ges;?>" size="5" /></td>            
            </tr>
			<tr>
			  <td colspan="5" bgcolor="#CCCCCC"><hr/></td>
	  	    </tr>
            ...
            <tr>
              ...
              <input name="fecha_ntrep1" type="text" id="fecha_ntrep1" title="Ingrese la fecha correspondiente" value="<?php echo $this->fechas_model->modificarFechas($modificar1->fecha_ntrep1);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              ...
              <input name="titulo_ntrep1" type="text" id="titulo_ntrep1" title="Ingrese los t&iacute;tulos de los resultados" value="<?php echo $modificar1->titulo_ntrep1;?>" size="30" onkeyup="javascript:this.value=this.value.toUpperCase();" /></td>            
            ...
            <tr>
              ...
              <input name="fecha_ntrep2" type="text" id="fecha_ntrep2" title="Ingrese la fecha correspondiente" value="<?php echo $this->fechas_model->modificarFechas($modificar1->fecha_ntrep2);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              ...
              <input name="titulo_ntrep2" type="text" id="titulo_ntrep2" title="Ingrese los t&iacute;tulos de los resultados" value="<?php echo $modificar1->titulo_ntrep2;?>" size="30" onkeyup="javascript:this.value=this.value.toUpperCase();" /></td>            
            ...
            <tr>
              ...
              <input name="fecha_trep1" type="text" id="fecha_trep1" title="Ingrese la fecha correspondiente" value="<?php echo $this->fechas_model->modificarFechas($modificar1->fecha_trep1);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              ...
              <td><input name="otra_trep1" type="text" id="otra_trep1" title="Ingrese otra prueba" value="<?php echo $modificar1->otra_trep1;?>" size="30" onkeyup="javascript:this.value=this.value.toUpperCase();" /></td>            
            ...
            <tr>
              ...
              <input name="fecha_trep2" type="text" id="fecha_trep2" title="Ingrese la fecha correspondiente" value="<?php echo $this->fechas_model->modificarFechas($modificar1->fecha_trep2);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              ...
              <td><input name="otra_trep2" type="text" id="otra_trep2" title="Ingrese otra prueba" value="<?php echo $modificar1->otra_trep2;?>" size="30" onkeyup="javascript:this.value=this.value.toUpperCase();" /></td>            
        ...
        <div id='congenita'>
   		<table width="100%" align="center">
            ...
            <tr>
              ...
              <input name="fecha_par" type="text" id="fecha_par" title="Ingrese la fecha correspondiente" value="<?php echo $this->fechas_model->modificarFechas($modificar2->fecha_par);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td><?php echo form_error('diresa', '<div class="warning">', '</div>'); ?>
                ...
                echo form_dropdown('diresa', $subreg, $establec_cong->subregion, 'id="diresa" style="width: 200px;"');
                ?>
              </td>
              <td><?php echo form_error('redes', '<div class="warning">', '</div>'); ?>
                <?php
                $red[''] = "Seleccione...";
                echo form_dropdown('redes', $red, $establec_cong->red, 'id="redes" style="width: 200px;"');
                ?>
              </td>
              <td><?php echo form_error('microred', '<div class="warning">', '</div>'); ?>
                <?php
                $mred[''] = "Seleccione...";
                echo form_dropdown('microred', $mred, $establec_cong->microred, 'id="microred" style="width: 200px;"');
                ?>
              </td>
              <td><?php echo form_error('establec', '<div class="warning">', '</div>'); ?>
                <?php
                $est[''] = "Seleccione...";
                echo form_dropdown('establec', $est, $modificar2->establec_par, 'id="establec" style="width: 200px;"');
                ?>
              </td>
            ...
            <tr>
              <td><strong>Fecha de fallecimiento: </strong><input name="fecha_fac" type="text" id="fecha_fac" title="Ingrese la fecha correspondiente" value="<?php echo $this->fechas_model->modificarFechas($modificar2->fecha_fac);?>" size="15" placeholder="Ej. dd-mm-YYYY" /></td>
              <td colspan="2"><strong>Peso al nacimiento: </strong><input name="peso_nac" type="text" id="peso_nac" title="Ingrese el peso al nacer" value="<?php echo $modificar2->peso_nac;?>" size="5" /><strong> gramos</strong></td>            
              <td colspan="2"><strong>Edad gestacional estimada: </strong><input name="edad_ges" type="text" id="edad_ges" title="Ingrese la edad gestacional" value="<?php echo $modificar2->edad_ges;?>" size="5" /><strong> semanas</strong></td>            
            </tr>
            <tr>
              <td>
              <?php
            ...
            <tr>
              <td><strong>Fecha de los test: </strong>&nbsp;&nbsp;<input name="fecha_test" type="text" id="fecha_test" title="Ingrese la fecha correspondiente" value="<?php echo $this->fechas_model->modificarFechas($modificar2->fecha_test);?>" size="12" placeholder="Ej. dd-mm-YYYY" /></td>
              <td>
              <?php
			  ...
			  ?>
              <td colspan="2"><strong>T&iacute;tulo de la madre:</strong>&nbsp;&nbsp;<input name="titulo_madre" type="text" id="titulo_madre" title="Ingrese los t&iacute;tulos de la madre" value="<?php echo $modificar2->titulo_madre;?>" size="20" /></td>
              <td colspan="2"><strong>T&iacute;tulo del ni&ntilde;o:</strong>&nbsp;&nbsp;<input name="titulo_hijo" type="text" id="titulo_hijo" title="Ingrese los t&iacute;tulos del ni&ntilde;o" value="<?php echo $modificar2->titulo_hijo;?>" size="20" /></td>
            </tr>
            <tr>
              <td colspan="6">
              <?php
        ...
        <table width="100%" align="center">
            ...
            <tr>
			  <td align="right">
                ...
                <input type="hidden" id="diagnostico" name="diagnostico" value="<?php echo $modificar->ciex;?>" />
			  </td>
		  </tr>
        </table>
    </div>
