...
<div class="container">
    ...
    <fieldset class="formulario">
      ...
      <div class='contenedor'>
          <div style="font-size:14px; font-weight:bold; text-align:center; padding:15px;">EDAs en menores de 5 años, por semanas epidemiológicas: Años <?php echo $ano1." - ".$ano2." - ".$ano3;?> - Nivel: <?php echo $vector;?></div>
