...
<div class="loginNotiWeb">
    ...
    <tr>
    <td width="50%" align="center"><h2><b>Reporte de Notificaci&oacute;n</b></h2></td>
    ...
    <tr><td><strong>&nbsp;&nbsp;Semana de proceso:</strong></td>
    <td align="left">
    ...
    <input type="button" id="botonSalir" name="cancelar" value="Cancelar" onclick="window.location='<?php echo site_url('reportes/generarCobertura'); ?>'" /></td>
    </tr>
    <tr><td colspan="2">&nbsp;</td></tr>
	</table>
</div>
