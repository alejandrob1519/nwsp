...
<div class="repNotiWeb">
    ...
    <tr>
    <td colspan="2" align="right"><h1>Informe de Notificaci&oacute;n de Infecciones Respiratorias Agudas (Iras y Neumon&iacute;as)</h1></td>
    ...
    <input type="button" id="botonLimpiar" name="limpiar" value="limpiar" onclick="window.location='<?php echo site_url('reportes/repIras'); ?>'" />
