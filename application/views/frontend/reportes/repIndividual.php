...
<div class="repNotiWeb">
    ...
    <tr>
    <td colspan="2" align="right"><h1>Informe de Notificaci&oacute;n Individual</h1></td>
	...
	<input type="radio" id="descrip2" name="opcion" value="e_ind" > Descripci&oacute;n en espacio
	<input type="radio" id="descrip3" name="opcion" value="p_ind" > Descripci&oacute;n en persona</b>';    
	?>
    </td>
    </tr>
    <tr><td colspan="4"><hr /></td></tr>
    <td width="22%"><strong>&nbsp;&nbsp;Diagn&oacute;stico de proceso:</strong></td>
    <td colspan="3">
	<?php 
    echo form_error('diagno', '<div class="warning">', '</div>'); 
    echo form_dropdown('diagno', $diagno, set_value('diagno'), 'id="diagno" style="width: 250px;"');
    ?>
    </td></tr>
    <tr><td colspan="4"><hr /></td></tr>
    <tr>
    ...
    <input type="button" id="botonLimpiar" name="limpiar" value="limpiar" onclick="window.location='<?php echo site_url('reportes/repIndividual'); ?>'" />
