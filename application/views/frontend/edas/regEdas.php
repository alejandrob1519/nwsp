...
$distrito[''] = "Seleccione...";
echo form_dropdown('distrito', $distrito, set_value('distrito'), 'id="distrito" style="width: 200px;" onchange="duplicadoEdas();" tabindex="12"');
?>
</td>
</tr>
</table>
...
<input name="daa_c1" type="text" id="daa_c1" title="Diarreas acuosas agudas en < 1 a&ntilde;o" value="<?php echo set_value('daa_c1')?>" size='10' tabindex="13" />
</td>
<td align="center">
<?php echo form_error('daa_c1_4', '<div class="warning">', '</div>'); ?> 
<input name="daa_c1_4" type="text" id="daa_c1_4" title="Diarreas acuosas agudas en < 4 a&ntilde;os" value="<?php echo set_value('daa_c1_4')?>" size='10' tabindex="14" />
</td>
<td align="center">
<?php echo form_error('daa_c5', '<div class="warning">', '</div>'); ?> 
<input name="daa_c5" type="text" id="daa_c5" title="Diarreas acuosas agudas en > 5 a&ntilde;os" value="<?php echo set_value('daa_c5')?>" size='10' tabindex="15" />
</td>
<td align="center">
<?php echo form_error('daa_d1', '<div class="warning">', '</div>'); ?> 
<input name="daa_d1" type="text" id="daa_d1" title="Defunciones en diareas acuosas agudas en < 1 a&ntilde;o" value="<?php echo set_value('daa_d1')?>" size='10' tabindex="16" />
</td>
<td align="center">
<?php echo form_error('daa_d1_4', '<div class="warning">', '</div>'); ?> 
<input name="daa_d1_4" type="text" id="daa_d1_4" title="Defunciones en diareas acuosas agudas en < 4 a&ntilde;os" value="<?php echo set_value('daa_d1_4')?>" size='10' tabindex="17" />
</td>
<td align="center">
<?php echo form_error('daa_d5', '<div class="warning">', '</div>'); ?> 
<input name="daa_d5" type="text" id="daa_d5" title="Defunciones en diareas acuosas agudas en > 5 a&ntilde;os" value="<?php echo set_value('daa_d5')?>" size='10' tabindex="18" />
</td>
<td align="center">
<?php echo form_error('daa_h1', '<div class="warning">', '</div>'); ?> 
<input name="daa_h1" type="text" id="daa_h1" title="Hospitalizados en diareas acuosas agudas en < 1 a&ntilde;o" value="<?php echo set_value('daa_h1')?>" size='10' tabindex="19" />
</td>
<td align="center">
<?php echo form_error('daa_h1_4', '<div class="warning">', '</div>'); ?> 
<input name="daa_h1_4" type="text" id="daa_h1_4" title="Hospitalizados en diareas acuosas agudas en < 4 a&ntilde;os" value="<?php echo set_value('daa_h1_4')?>" size='10' tabindex="20" />
</td>
<td align="center">
<?php echo form_error('daa_h5', '<div class="warning">', '</div>'); ?> 
<input name="daa_h5" type="text" id="daa_h5" title="Hospitalizados en diareas acuosas agudas en > 5 a&ntilde;os" value="<?php echo set_value('daa_h5')?>" size='10' tabindex="21" />
</td>
</tr>
<tr><td colspan="9" valign="middle"><hr/></td></tr>
...
<input name="dis_c1" type="text" id="dis_c1" title="Diarreas disent&eacute;ricas en < 1 a&ntilde;o" value="<?php echo set_value('dis_c1')?>" size='10' tabindex="22" />
</td>
<td align="center">
<?php echo form_error('dis_c1_4', '<div class="warning">', '</div>'); ?> 
<input name="dis_c1_4" type="text" id="dis_c1_4" title="Diarreas disent&eacute;ricas en < 4 a&ntilde;os" value="<?php echo set_value('dis_c1_4')?>" size='10' tabindex="23" />
</td>
<td align="center">
<?php echo form_error('dis_c5', '<div class="warning">', '</div>'); ?> 
<input name="dis_c5" type="text" id="dis_c5" title="Diarreas disent&eacute;ricas en > 5 a&ntilde;os" value="<?php echo set_value('dis_c5')?>" size='10' tabindex="24" />
</td>
<td align="center">
<?php echo form_error('dis_d1', '<div class="warning">', '</div>'); ?> 
<input name="dis_d1" type="text" id="dis_d1" title="Defunciones en diareas disent&eacute;ricas en < 1 a&ntilde;o" value="<?php echo set_value('dis_d1')?>" size='10' tabindex="25" />
</td>
<td align="center">
<?php echo form_error('dis_d1_4', '<div class="warning">', '</div>'); ?> 
<input name="dis_d1_4" type="text" id="dis_d1_4" title="Defunciones en diareas disent&eacute;ricas en < 4 a&ntilde;os" value="<?php echo set_value('dis_d1_4')?>" size='10' tabindex="26" />
</td>
<td align="center">
<?php echo form_error('dis_d5', '<div class="warning">', '</div>'); ?> 
<input name="dis_d5" type="text" id="dis_d5" title="Defunciones en diareas disent&eacute;ricas en > 5 a&ntilde;os" value="<?php echo set_value('dis_d5')?>" size='10' tabindex="27" />
</td>
<td align="center">
<?php echo form_error('dis_h1', '<div class="warning">', '</div>'); ?> 
<input name="dis_h1" type="text" id="dis_h1" title="Hospitalizados en diareas disent&eacute;ricas en < 1 a&ntilde;o" value="<?php echo set_value('dis_h1')?>" size='10' tabindex="28" />
</td>
<td align="center">
<?php echo form_error('dis_h1_4', '<div class="warning">', '</div>'); ?> 
<input name="dis_h1_4" type="text" id="dis_h1_4" title="Hospitalizados en diareas disent&eacute;ricas en < 4 a&ntilde;os" value="<?php echo set_value('dis_h1_4')?>" size='10' tabindex="29" />
</td>
<td align="center">
<?php echo form_error('dis_h5', '<div class="warning">', '</div>'); ?> 
<input name="dis_h5" type="text" id="dis_h5" title="Hospitalizados en diareas disent&eacute;ricas en > 5 a&ntilde;os" value="<?php echo set_value('dis_h5')?>" size='10' tabindex="30" />
</td>
</tr>
<tr><td colspan="9" valign="middle"><hr/></td></tr>
<tr>
