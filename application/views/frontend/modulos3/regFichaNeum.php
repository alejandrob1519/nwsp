...
<td valign="middle">
<input name="institucion" type="text" id="institucion" title="Ingrese la instituci&oacute;n" value="<?php echo set_value('institucion')?>" size='25' tabindex="5" readonly="readonly" />
</td>
<td>
<?php echo form_error('fecha_reg', '<div class="warning">', '</div>'); ?> 
<input name="fecha_reg" type="text" id="fecha_reg" tabindex="6" title="Ingrese la fecha de registro" value="<?php echo set_value('fecha_reg')?>" size='20' placeholder='Ejm. dd-mm-YYYY' />
</td>
</tr>
<tr><td colspan="6" valign="middle"><hr/></td></tr>
<tr>
...
<input name="apepat" type="text" id="apepat" title="Ingrese el apellido paterno" value="<?php echo set_value('apepat')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" tabindex="7" />
</td>
...
<input name="apemat" type="text" id="apemat" title="Ingrese el apellido materno" value="<?php echo set_value('apemat')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" tabindex="8" />
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Nombres</strong></td>
<td>
<?php echo form_error('nombres', '<div class="warning">', '</div>'); ?> 
<input name="nombres" type="text" id="nombres" title="Ingrese los nombres" value="<?php echo set_value('nombres')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" tabindex="9" />
</td>
<tr>
...
echo form_dropdown('sexo', $sexo, set_value('sexo'), 'id="sexo" style="width: 150px;" tabindex="10"');
?>
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Fecha de nacimiento</strong></td>
<td>
<?php echo form_error('fecha_nac', '<div class="warning">', '</div>'); ?> 
<input name="fecha_nac" type="text" id="fecha_nac" tabindex="11" title="Ingrese la fecha de nacimiento" value="<?php echo set_value('fecha_nac')?>" size='20' placeholder='Ejm. dd-mm-YYYY' />
</td>
</tr>
<tr>
...
<input name="direccion" type="text" id="direccion" title="Direcci&oacute;n habitual" value="<?php echo set_value('direccion')?>" size='71' onkeyup="javascript:this.value=this.value.toUpperCase();" tabindex="12" />
</td>
</tr>
<tr>
...
echo form_dropdown('departamento', $departamento, set_value('departamento'), 'id="departamento" style="width: 150px;" tabindex="13"');
?>
</td>
...
echo form_dropdown('provincia', $provincia, set_value('provincia'), 'id="provincia" style="width: 150px;" tabindex="14"');
?>
</td>
...
$distrito[''] = "Seleccione...";
echo form_dropdown('distrito', $distrito, set_value('distrito'), 'id="distrito" style="width: 150px;" tabindex="15"');
?>
</td>
</tr>
<tr>
...
echo form_dropdown('zona', $zona, set_value('zona'), 'id="zona" style="width: 150px;" tabindex="16"');
?>
</td>
...
<input name="fecha_def" type="text" id="fecha_def" tabindex="17" title="Ingrese la fecha de defunci&oacute;n" value="<?php echo set_value('fecha_def')?>" size='20' placeholder='Ejm. dd-mm-YYYY' />
</td>
...
<input name="hora_def" type="text" id="hora_def" title="Hora de defunci&oacute;n" value="<?php echo set_value('hora_def')?>" size="8" tabindex="18" placeholder="Ej. 99.99" />
</td>
</tr>
<tr><td colspan="6" valign="middle"><hr/></td></tr>
<tr>
...
echo form_dropdown('departamento14_1', $departamento14_1, set_value('departamento14_1'), 'id="departamento14_1" style="width: 150px;" tabindex="19"');
?>
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Provincia</strong></td>
<td valign="middle">
...
echo form_dropdown('provincia14_1', $provincia14_1, set_value('provincia14_1'), 'id="provincia14_1" style="width: 150px;" tabindex="20"');
?>
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Distrito</strong></td>
<td valign="middle">
...
echo form_dropdown('distrito14_1', $distrito14_1, set_value('distrito14_1'), 'id="distrito14_1" style="width: 150px;" tabindex="21"');
?>
</td>
</tr>
<tr>
...
echo form_dropdown('lugar_def', $lugar_def, set_value('lugar_def'), 'id="lugar_def" style="width: 150px;" tabindex="22"');
?>
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Otro</strong></td>
<td>
<?php echo form_error('otro_def', '<div class="warning">', '</div>'); ?> 
<input name="otro_def" type="text" id="otro_def" title="Otro Lugar" value="<?php echo set_value('otro_def')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="25" tabindex="23" disabled="disabled" />
</td>
</tr>
<tr><td colspan="6" valign="middle"><hr/></td></tr>
<tr>
...
echo form_dropdown('cuidador', $cuidador, set_value('cuidador'), 'id="cuidador" style="width: 150px;" tabindex="24"');
?>
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Otro</strong></td>
<td>
<?php echo form_error('cuida_otro', '<div class="warning">', '</div>'); ?> 
<input name="cuida_otro" type="text" id="cuida_otro" title="Otro cuidador" value="<?php echo set_value('cuida_otro')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="25" tabindex="25" disabled="disabled" />
</td>
</tr>
<tr>
...
<input name="fecha_ini" type="text" id="fecha_ini" tabindex="26" title="Ingrese la fecha de inicio de la enfermedad" value="<?php echo set_value('fecha_ini')?>" size='20' placeholder='Ejm. dd-mm-YYYY' />
</td>
...
echo form_dropdown('lugar_atencion', $lugar_atencion, set_value('lugar_atencion'), 'id="lugar_atencion" style="width: 150px;" tabindex="27"');
?>
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Otro</strong></td>
<td>
<?php echo form_error('otro_lugar', '<div class="warning">', '</div>'); ?> 
<input name="otro_lugar" type="text" id="otro_lugar" title="Otro Lugar" value="<?php echo set_value('otro_lugar')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" tabindex="28" disabled="disabled" />
</td>
</tr>
<tr>
...
<input name="fecha_ate" type="text" id="fecha_ate" tabindex="29" title="Ingrese la fecha de la primera atenci&oacute;n" value="<?php echo set_value('fecha_ate')?>" size='20' placeholder='Ejm. dd-mm-YYYY' />
</td>
...
echo form_dropdown('gravedad_tran', $gravedad_tran, set_value('gravedad_tran'), 'id="gravedad_tran" style="width: 150px;" tabindex="30"');
?>
</td>
...
echo form_dropdown('acepto_tran', $acepto_tran, set_value('acepto_tran'), 'id="acepto_tran" style="width: 150px;" tabindex="31"');
?>
</td>
<tr>
...
<input name="fecha_tra" type="text" id="fecha_tra" tabindex="32" title="Ingrese la fecha de la transferencia" value="<?php echo set_value('fecha_tra')?>" size='20' placeholder='Ejm. dd-mm-YYYY' />
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Hora de transferencia</strong></td>
<td>
<?php echo form_error('hora_tra', '<div class="warning">', '</div>'); ?> 
<input name="hora_tra" type="text" id="hora_tra" title="Hora de la transferencia" size="8" value="<?php echo set_value('hora_tra')?>" tabindex="33" placeholder="Ej. 99.99" />
</td>
</tr>
<tr>
...
echo form_dropdown('seguro', $seguro, set_value('seguro'), 'id="seguro" style="width: 150px;" tabindex="34"');
?>
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Otro</strong></td>
<td>
<?php echo form_error('otro_seguro', '<div class="warning">', '</div>'); ?> 
<input name="otro_seguro" type="text" id="otro_seguro" title="Otro seguro" value="<?php echo set_value('otro_seguro')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" tabindex="35" disabled="disabled" />
</td>
</tr>
<tr>
...
echo form_dropdown('programa', $programa, set_value('programa'), 'id="programa" style="width: 150px;" tabindex="36"');
?>
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Otro</strong></td>
<td>
<?php echo form_error('otro_programa', '<div class="warning">', '</div>'); ?> 
<input name="otro_programa" type="text" id="otro_programa" title="Otro programa" value="<?php echo set_value('otro_programa')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" tabindex="37" disabled="disabled" />
</td>
</tr>
<tr><td colspan="6" valign="middle"><hr/></td></tr>
<tr>
...
echo form_dropdown('pentavalente', $pentavalente, set_value('pentavalente'), 'id="pentavalente" style="width: 150px;" tabindex="38"');
?>
</td>
...
echo form_dropdown('neumococo', $neumococo, set_value('neumococo'), 'id="neumococo" style="width: 150px;" tabindex="39"');
?>
</td>
...
echo form_dropdown('influenza', $influenza, set_value('influenza'), 'id="influenza" style="width: 150px;" tabindex="40"');
?>
</td>
</tr>
<tr><td colspan="6" valign="middle"><hr/></td></tr>
...
<input name="talla" type="text" id="talla" title="Talla" value="<?php echo set_value('talla')?>" size="10" tabindex="41" placeholder="Ej. 2.50 mt" />
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Peso</strong></td>
<td>
<?php echo form_error('peso', '<div class="warning">', '</div>'); ?> 
<input name="peso" type="text" id="peso" title="Peso" value="<?php echo set_value('peso')?>" size="10" tabindex="42" placeholder="Ej. 2.50 Kgr." />
</td>
<td>
<?php 
$nutricion = array("" => "Seleccione...", "1" => "Eutr&oacute;fico", "2" => "Desnutrido");
echo form_error('nutricion', '<div class="warning">', '</div>'); 
echo form_dropdown('nutricion', $nutricion, set_value('nutricion'), 'id="nutricion" style="width: 150px;" tabindex="43"');
?>
</td>
<td>
<?php 
...
echo form_dropdown('tipo', $tipo, set_value('tipo'), 'id="tipo" style="width: 100px;" tabindex="44"');
?>
</td>
</tr>
<tr>
...
echo form_dropdown('lactancia', $lactancia, set_value('lactancia'), 'id="lactancia" style="width: 150px;" tabindex="45"');
?>
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Otro</strong></td>
<td>
<?php echo form_error('otro_lactancia', '<div class="warning">', '</div>'); ?> 
<input name="otro_lactancia" type="text" id="otro_lactancia" title="Otro tipo de lactancia" value="<?php echo set_value('otro_lactancia')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" tabindex="46" disabled="disabled" />
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>No. Controles CRED</strong></td>
<td>
<?php echo form_error('cred', '<div class="warning">', '</div>'); ?> 
<input name="cred" type="text" id="cred" title="No. controles CRED" value="<?php echo set_value('cred')?>" size="12" tabindex="47" />
</td>
</tr>
<tr><td colspan="6" valign="middle"><hr/></td></tr>
<tr>
...
echo form_dropdown('hospital', $hospital, set_value('hospital'), 'id="hospital" style="width: 100px;" tabindex="48"');
?>
</td>
</tr>
<tr><td colspan="6" valign="middle"><hr/></td></tr>
...
<input name="fecha_eme" type="text" id="fecha_eme" tabindex="49" title="Ingrese la fecha de ingreso a emergencia" value="<?php echo set_value('fecha_eme')?>" size='20' placeholder='Ejm. dd-mm-YYYY' />
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Hora</strong></td>
<td>
<?php echo form_error('hora_eme', '<div class="warning">', '</div>'); ?> 
<input name="hora_eme" type="text" id="hora_eme" title="Hora de ingreso a emergencia" value="<?php echo set_value('hora_eme')?>" size="10" tabindex="51" placeholder="Ej. 99.99" />
</td>
</tr>
<tr>
...
<input name="fecha_hos" type="text" id="fecha_hos" tabindex="52" title="Ingrese la fecha de ingreso a hospitalizaci&oacute;n" value="<?php echo set_value('fecha_hos')?>" size='20' placeholder='Ejm. dd-mm-YYYY' />
</td>
<td valign="middle" bgcolor="#CCCCCC"><strong>Hora</strong></td>
<td>
<?php echo form_error('hora_hos', '<div class="warning">', '</div>'); ?> 
<input name="hora_hos" type="text" id="hora_hos" title="Hora de ingreso a hospitalizaci&oacute;n" value="<?php echo set_value('hora_hos')?>" size="10" tabindex="53" placeholder="Ej. 99.99" />
</td>
</tr>
<tr>
...
<input name="dx1" type="text" id="dx1" title="Diagn&oacute;stico de Ingreso" value="<?php echo set_value('dx1')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="45" tabindex="54" />
</td>
</tr>
<tr>
<td valign="middle">&nbsp;</td>
...
<input name="dx2" type="text" id="dx2" title="Diagn&oacute;stico de Ingreso" value="<?php echo set_value('dx2')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="45" tabindex="55" />
</td>
</tr>
<tr>
<td valign="middle">&nbsp;</td>
...
<input name="dx3" type="text" id="dx3" title="Diagn&oacute;stico de Ingreso" value="<?php echo set_value('dx3')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="45" tabindex="56" />
</td>
</tr>
<tr><td colspan="6" valign="middle"><hr/></td></tr>
<tr>
...
<input name="cbasica" type="text" id="cbasica" title="Causa B&aacute;sica" value="<?php echo set_value('cbasica')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="45" tabindex="57" />
</td>
</tr>
<tr>
...
<input name="cintermedia" type="text" id="cintermedia" title="Causa Intermedia" value="<?php echo set_value('cintermedia')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="45" tabindex="58" />
</td>
</tr>
<tr>
...
<input name="cterminal" type="text" id="cterminal" title="Causa Terminal" value="<?php echo set_value('cterminal')?>" onkeyup="javascript:this.value=this.value.toUpperCase();" size="45" tabindex="59" />
</td>
</tr>
<tr>
