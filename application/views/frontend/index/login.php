<div class="container">
    ...
    <div class="row">
        ...
        <div style="position:relative; float:left; font-size:12px; text-align:center; width:20%; margin-top: 2%; margin-left:30%; margin-bottom:6%;">
        <a href="<?php echo site_url('index/solicitud');?>">
        <img src="../../public/images/usuario.png" width="35px" height="35px" title="Registrar su usuario y contrase&ntilde;a" /><br/>
        Registrar su usuario</a>
        </div>
        
        <div style="position:relative; float:left; font-size:12px; text-align:center; width:20%; margin-top: 2%; margin-bottom:6%;">
        <a href="<?php echo site_url('index/olvido');?>">
        <img src="../../public/images/candado.jpg" width="35px" height="35px" title="Recuperar usuario y/o contrase&ntilde;a" /><br/>
