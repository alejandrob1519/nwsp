			...
			<div class="tab-pane fade in active" id="tabs-1">
						...
						<div class="col-sm-4 col-md-3 col-lg-3">
							...
							<div class="col-middle">
								<label class="checkbox-inline">
									<input type="checkbox" name="ref_es" <?php echo ($modificar->ref_es=='1') ? 'checked="checked"' : '';  ?>
									id="ref_es" value="1" onchange="javascript:mostrar_contenido()" onClick="habilita_elemento()" />2.1 El Paciente es Referido?
								</label>
							</div>
						</div>
					</div>
				...
				<div class="row list-group-item">
					...
					<div class="row clearfix">
						...
						<div class="col-xs-6 col-sm-4 col-lg-3 fecha_ingreso_lesion">
				...
				<div class="row list-group-item">
					<div class="row clearfix">
						...
						<div class="col-xs-8 col-sm-4 col-lg-4">
							...
							value="<?php echo ($modificar->dx1!='') ? $dataDx1->diagno : '';?>" placeholder="Ingrese el CIEX o Diagnostico" data-toggle="tooltip" title="Escribe el codigo CIEX o el nombre de diagnostico">
							</div>
						</div>
						<div class="col-xs-4 col-sm-2 col-lg-2">
					...
					<div class="row clearfix">
						...
						<div class="col-xs-8 col-sm-4 col-lg-4">
							<input type="text" id="diagno2" class="form-control"
							  value="<?php echo ($modificar->dx2!='') ? $dataDx2->diagno : '';?>" placeholder="Ingrese el CIEX o Diagnostico" data-toggle="tooltip" title="Escribe el codigo CIEX o el nombre de diagnostico">
						</div>
						<div class="col-xs-4 col-sm-2 col-lg-2">
					...
					<div class="row clearfix">
						...
						<div class="col-xs-8 col-sm-4 col-lg-4">
							<input type="text" id="diagno3" class="form-control"
							value="<?php echo ($modificar->dx3!='') ? $dataDx3->diagno : '';?>" placeholder="Ingrese el CIEX o Diagnostico" data-toggle="tooltip" title="Escribe el codigo CIEX o el nombre de diagnostico">
						</div>
						<div class="col-xs-4 col-sm-2 col-lg-2">
				...
				<div class="row">
					<div class="col-xs-offset-6 col-sm-offset-9 col-md-offset-9 col-lg-offset-10">
						<button type="submit" class="btn btn-primary ladda-button" data-style="expand-right"><span class="ladda-label">Actualizar</span><span class="ladda-spinner"></span><div class="ladda-progress" style="width: 0px;"></div></button>
				...
				<div class="row list-group-item">
					<div class="row clearfix">
						<div class="col-xs-6 col-sm-3 col-lg-3">
							...
							<div class="input-group">
								<div class="form-group">
									<input type='text' class="form-control datepicker" name="fec_accd" value="<?php echo  $this->fechas_model->modificarFechas($modificar->fec_accd); ?>"
									id="fecha_accidente" placeholder="dd-mm-aaaa" value="<?php echo set_value('fecha_accidente')?>" onKeyPress="return acceptNum(event)" />
									</div>
							...
							<tr>
								...
								<td>
									<label class="radio-inline">
										...
										id="inlineRadio2111" value="11">21.11 Avioneta/Helicoptero
									</label>
								</td>
							</tr>
							<tr>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8 col-lg-5">
							...
							<div class="row">
								...
								<label class="radio-inline">
								  <input type="radio" name="lic_conduc" <?php echo ($modificar->lic_conduc=='NOSABE') ? 'checked="checked"' : ''; ?> id="inlineRadio263" value="NOSABE" onClick="habilita_elemento()"> NOSABE
								</label>
								<label class="radio-inline">
								  <input type="text" name="lic_conduc" value="<?php echo $modificar->lic_conduc; ?>"
									id="licenciaconducir" placeholder="Nro Licencia" class="form-control" readonly>
								</label>
							</div>
						</div>
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group">
										  ...
										  <input type="text" name="otroaseg" placeholder="otra aseguradora.." value="<?php echo $modificar->otroaseg; ?>" id="otraaseguradora" class="form-control" readonly>
										</div>
									</td>
								</tr>
							</table>
