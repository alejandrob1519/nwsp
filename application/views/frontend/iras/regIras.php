...
$etnias[''] = "Seleccione...";
echo form_dropdown('etnias', $etnias, set_value('etnias'), 'id="etnias" style="width: 160px;" tabindex="3"');
?>
</td>
<td valign="middle">
<?php echo form_error('subetnias', '<div class="warning">', '</div>'); 
$subetnias[''] = "Seleccione...";
echo form_dropdown('subetnias', $subetnias, set_value('subetnias'), 'id="subetnias" style="width: 200px;" tabindex="4"');
?>
</td>
<td>
<?php echo form_error('otro', '<div class="warning">', '</div>'); ?> 
<input name="otro" type="text" id="otro" title="Otra etnia de procedencia del paciente" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo set_value('otro')?>" size='20' placeholder="Otra etnia" disabled="disabled" tabindex="4" />
</td>
...
echo form_dropdown('zona', $zona, set_value('zona'), 'id="zona" style="width: 200px;" tabindex="5"');
?>
</td>
</tr>
<tr>
...
//$diresa[''] = "Seleccione...";
echo form_dropdown('diresa', $diresa, set_value('diresa'), 'id="diresa" style="width: 160px;" tabindex="6"');
?>
</td>
...
//$redes[''] = "Seleccione...";
echo form_dropdown('redes', $redes, set_value('redes'), 'id="redes" style="width: 200px;" tabindex="7"');
?>
</td>
...
//$microred[''] = "Seleccione...";
echo form_dropdown('microred', $microred, set_value('microred'), 'id="microred" style="width: 200px;" tabindex="8"');
?>
</td>
...
//$establec[''] = "Seleccione...";
echo form_dropdown('establec', $establec, set_value('establec'), 'id="establec" style="width: 200px;" tabindex="9"');
?>
</td>
</tr>
<tr>
...
echo form_dropdown('departamento', $departamento, set_value('departamento'), 'id="departamento" style="width: 160px;" tabindex="10"');
?>
</td>
...
echo form_dropdown('provincia', $provincia, set_value('provincia'), 'id="provincia" style="width: 200px;" tabindex="11"');
?>
</td>
...
$distrito[''] = "Seleccione...";
echo form_dropdown('distrito', $distrito, set_value('distrito'), 'id="distrito" style="width: 200px;" onchange="duplicadoIras();" tabindex="12"');
?>
</td>
</tr>
</table>
...
<input name="ira_m2" type="text" id="ira_m2" value="<?php echo set_value('ira_m2')?>" size='15' tabindex="13" />
</td>
<td>
</td>
<td align="center">
<?php echo form_error('ngr_m2', '<div class="warning">', '</div>'); ?> 
<input name="ngr_m2" type="text" id="ngr_m2" value="<?php echo set_value('ngr_m2')?>" size='15' tabindex="22" />
</td>
<td align="center">
<?php echo form_error('hos_m2', '<div class="warning">', '</div>'); ?> 
<input name="hos_m2" type="text" id="hos_m2" value="<?php echo set_value('hos_m2')?>" size='15' tabindex="25" />
</td>
<td align="center">
<?php echo form_error('dih_m2', '<div class="warning">', '</div>'); ?> 
<input name="dih_m2" type="text" id="dih_m2" value="<?php echo set_value('dih_m2')?>" size='15' tabindex="32" />
</td>
<td align="center">
<?php echo form_error('deh_m2', '<div class="warning">', '</div>'); ?> 
<input name="deh_m2" type="text" id="deh_m2" value="<?php echo set_value('deh_m2')?>" size='15' tabindex="39" />
</td>
</tr>
<tr>
...
<input name="ira_2_11" type="text" id="ira_2_11" value="<?php echo set_value('ira_2_11')?>" size='15' tabindex="14" />
</td>
<td align="center">
<?php echo form_error('neu_2_11', '<div class="warning">', '</div>'); ?> 
<input name="neu_2_11" type="text" id="neu_2_11" value="<?php echo set_value('neu_2_11')?>" size='15' tabindex="16" />
</td>
<td align="center">
<?php echo form_error('ngr_2_11', '<div class="warning">', '</div>'); ?> 
<input name="ngr_2_11" type="text" id="ngr_2_11" value="<?php echo set_value('ngr_2_11')?>" size='15' tabindex="23" />
</td>
<td align="center">
<?php echo form_error('hos_2_11', '<div class="warning">', '</div>'); ?> 
<input name="hos_2_11" type="text" id="hos_2_11" value="<?php echo set_value('hos_2_11')?>" size='15' tabindex="26" />
</td>
<td align="center">
<?php echo form_error('dih_2_11', '<div class="warning">', '</div>'); ?> 
<input name="dih_2_11" type="text" id="dih_2_11" value="<?php echo set_value('dih_2_11')?>" size='15' tabindex="33" />
</td>
<td align="center">
<?php echo form_error('deh_2_11', '<div class="warning">', '</div>'); ?> 
<input name="deh_2_11" type="text" id="deh_2_11" value="<?php echo set_value('deh_2_11')?>" size='15' tabindex="40" />
</td>
</tr>
<tr>
...
<input name="ira_1_4a" type="text" id="ira_1_4a" value="<?php echo set_value('ira_1_4a')?>" size='15' tabindex="15" />
</td>
<td align="center">
<?php echo form_error('neu_1_4a', '<div class="warning">', '</div>'); ?> 
<input name="neu_1_4a" type="text" id="neu_1_4a" value="<?php echo set_value('neu_1_4a')?>" size='15' tabindex="17" />
</td>
<td align="center">
<?php echo form_error('ngr_1_4a', '<div class="warning">', '</div>'); ?> 
<input name="ngr_1_4a" type="text" id="ngr_1_4a" value="<?php echo set_value('ngr_1_4a')?>" size='15' tabindex="24" />
</td>
<td align="center">
<?php echo form_error('hos_1_4a', '<div class="warning">', '</div>'); ?> 
<input name="hos_1_4a" type="text" id="hos_1_4a" value="<?php echo set_value('hos_1_4a')?>" size='15' tabindex="27" />
</td>
<td align="center">
<?php echo form_error('dih_1_4a', '<div class="warning">', '</div>'); ?> 
<input name="dih_1_4a" type="text" id="dih_1_4a" value="<?php echo set_value('dih_1_4a')?>" size='15' tabindex="34" />
</td>
<td align="center">
<?php echo form_error('deh_1_4a', '<div class="warning">', '</div>'); ?> 
<input name="deh_1_4a" type="text" id="deh_1_4a" value="<?php echo set_value('deh_1_4a')?>" size='15' tabindex="41" />
</td>
</tr>
<tr><td colspan="9" valign="middle"><hr/></td></tr>
<tr>
...
<input name="neu_5_9a" type="text" id="neu_5_9a" value="<?php echo set_value('neu_5_9a')?>" size='15' tabindex="18" />
</td>
<td align="center">
</td>
<td align="center">
<?php echo form_error('hos_5_9a', '<div class="warning">', '</div>'); ?> 
<input name="hos_5_9a" type="text" id="hos_5_9a" value="<?php echo set_value('hos_5_9a')?>" size='15' tabindex="28" />
</td>
<td align="center">
<?php echo form_error('dih_5_9a', '<div class="warning">', '</div>'); ?> 
<input name="dih_5_9a" type="text" id="dih_5_9a" value="<?php echo set_value('dih_5_9a')?>" size='15' tabindex="35" />
</td>
<td align="center">
<?php echo form_error('deh_5_9a', '<div class="warning">', '</div>'); ?> 
<input name="deh_5_9a" type="text" id="deh_5_9a" value="<?php echo set_value('deh_5_9a')?>" size='15' tabindex="42" />
</td>
</tr>
<tr>
...
<input name="neu_10_19" type="text" id="neu_10_19" value="<?php echo set_value('neu_10_19')?>" size='15' tabindex="19" />
</td>
<td align="center">
</td>
<td align="center">
<?php echo form_error('hos_10_19', '<div class="warning">', '</div>'); ?> 
<input name="hos_10_19" type="text" id="hos_10_19" value="<?php echo set_value('hos_10_19')?>" size='15' tabindex="29" />
</td>
<td align="center">
<?php echo form_error('dih_10_19', '<div class="warning">', '</div>'); ?> 
<input name="dih_10_19" type="text" id="dih_10_19" value="<?php echo set_value('dih_10_19')?>" size='15' tabindex="36" />
</td>
<td align="center">
<?php echo form_error('deh_10_19', '<div class="warning">', '</div>'); ?> 
<input name="deh_10_19" type="text" id="deh_10_19" value="<?php echo set_value('deh_10_19')?>" size='15' tabindex="43" />
</td>
</tr>
<tr>
...
<input name="neu_20_59" type="text" id="neu_20_59" value="<?php echo set_value('neu_20_59')?>" size='15' tabindex="20" />
</td>
<td align="center">
</td>
<td align="center">
<?php echo form_error('hos_20_59', '<div class="warning">', '</div>'); ?> 
<input name="hos_20_59" type="text" id="hos_20_59" value="<?php echo set_value('hos_20_59')?>" size='15' tabindex="30" />
</td>
<td align="center">
<?php echo form_error('dih_20_59', '<div class="warning">', '</div>'); ?> 
<input name="dih_20_59" type="text" id="dih_20_59" value="<?php echo set_value('dih_20_59')?>" size='15' tabindex="37" />
</td>
<td align="center">
<?php echo form_error('deh_20_59', '<div class="warning">', '</div>'); ?> 
<input name="deh_20_59" type="text" id="deh_20_59" value="<?php echo set_value('deh_20_59')?>" size='15' tabindex="44" />
</td>
</tr>
<tr>
...
<input name="neu_60a" type="text" id="neu_60a" value="<?php echo set_value('neu_60a')?>" size='15' tabindex="21" />
</td>
<td align="center">
</td>
<td align="center">
<?php echo form_error('hos_60a', '<div class="warning">', '</div>'); ?> 
<input name="hos_60a" type="text" id="hos_60a" value="<?php echo set_value('hos_60a')?>" size='15' tabindex="31" />
</td>
<td align="center">
<?php echo form_error('dih_60a', '<div class="warning">', '</div>'); ?> 
<input name="dih_60a" type="text" id="dih_60a" value="<?php echo set_value('dih_60a')?>" size='15' tabindex="38" />
</td>
<td align="center">
<?php echo form_error('deh_60a', '<div class="warning">', '</div>'); ?> 
<input name="deh_60a" type="text" id="deh_60a" value="<?php echo set_value('deh_60a')?>" size='15' tabindex="45" />
</td>
</tr>
<tr><td colspan="9" valign="middle"><hr/></td></tr>
<tr>
...
<input name="sob_2a" type="text" id="sob_2a" value="<?php echo set_value('sob_2a')?>" size='15' tabindex="46" />
</td>
</tr>
<tr>
...
<input name="sob_2_4a" type="text" id="sob_2_4a" value="<?php echo set_value('sob_2_4a')?>" size='15' tabindex="47" />
</td>
</tr>
<tr><td colspan="9" valign="middle"><hr/></td></tr>
<tr>
