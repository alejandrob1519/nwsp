...
<section class="wrapper">
  ...
  <legend><strong>Generaci&oacute;n de Mapas Epidemiol&oacute;gicos</strong></legend>
    <div class='contenedor'>
        ...
        <label>
          <select name="opciones" id="opciones" style="width:100%;">
	            <option value="99" selected="selected">Elija la opci&oacute;n</option>
            	<option value="1">Mapas por UBIGEO</option>
	            <!--<option value="2">Mapas por DIRESA</option>-->
          </select>
        </label>
		...
		<select name='nivel' id='nivel' style="width:100%">
			<option value='99'>Elija la opci&oacute;n...</option>
		</select>
        </label>
        ...
        <input type="button" id="botonAnadir" name="enviar" value="Generar" title="Generar el mapa georeferenciado" />
        <input type="button" id="botonSalir" name="enviar" value="Salir" title="Regresar a la p&aacute;gina anterior" onclick="javascript:location.href='<?php echo site_url('index/principal')?>';" />
        <br />
        <br />
        <input type="button" id="botonLimpiar" name="enviar" value="&nbsp;&nbsp;&nbsp;Limpiar" title="Refrescar la p&aacute;gina" onclick="javascript:location.href='<?php echo site_url('mapas')?>';" />
        <br />
        <br />
        </div>
