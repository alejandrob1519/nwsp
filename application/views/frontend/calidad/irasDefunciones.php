...
<div id="tmm-form-wizard">
	...
	?>
        <div class="prev">
        	<button class="button button-control" type="button" id="atras" onClick="window.location.href='<?php echo site_url("/calidad/irasEstablecimientos"); ?>'"><span>Paso Anterior <b>Establecimientos</b></span></button>
            <div class="button-divider"></div>
        </div>
    
        <div class="next">
            <button class="button button-control" type="button" id="siguiente" onClick="window.location.href='<?php echo site_url("/calidad/irasCampos"); ?>'"><span>Siguiente Paso <b>Campos Vac&iacute;os</b></span></button>
            <div class="button-divider"></div>
        </div>
