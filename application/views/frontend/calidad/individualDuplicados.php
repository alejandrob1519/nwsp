...
<div id="tmm-form-wizard">
	...
	?>
        <div class="prev">
        	<button class="button button-control" type="button" id="atras" onClick="window.location.href='<?php echo site_url("/calidad/individualDiagnostico"); ?>'"><span>Paso Anterior <b>Diagn&oacute;sticos</b></span></button>
            <div class="button-divider"></div>
        </div>
    
        <div class="next">
            <button class="button button-control" type="button" id="siguiente" onClick="window.location.href='<?php echo site_url("/calidad/inconsistencias"); ?>'"><span>Siguiente Paso <b>Inconsistencias</b></span></button>
            <div class="button-divider"></div>
        </div>
