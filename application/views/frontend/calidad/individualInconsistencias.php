...
<div id="tmm-form-wizard">
	...
	?>
        <div class="prev">
        	<button class="button button-control" type="button" id="atras" onClick="window.location.href='<?php echo site_url("/calidad/individualDuplicados"); ?>'"><span>Paso Anterior <b>Duplicados</b></span></button>
            <div class="button-divider"></div>
        </div>
    
        <div class="next">
            <button class="button button-control" type="button" id="siguiente" onClick="window.location.href='<?php echo site_url("/calidad/individualEstablecimientos"); ?>'"><span>Siguiente Paso <b>Establecimientos</b></span></button>
            <div class="button-divider"></div>
        </div>
