...
<div id="tmm-form-wizard">
	...
	?>
        <div class="prev">
        	<button class="button button-control" type="button" id="atras" onClick="window.location.href='<?php echo site_url("/calidad/edasSemanas"); ?>'"><span>Paso Anterior <b>Semanas</b></span></button>
            <div class="button-divider"></div>
        </div>
    
        <div class="next">
            <button class="button button-control" type="button" id="siguiente" onClick="window.location.href='<?php echo site_url("/calidad/edasDefunciones"); ?>'"><span>Siguiente Paso <b>Defunciones</b></span></button>
            <div class="button-divider"></div>
        </div>
