...
<!--Esto es de mi cosecha-->
		<?php 
		if($unset_add){
			foreach($this->actions_peru as $value){
				$action_url = $value->link_url_peru;
			}?>
		
			<div class="tDiv2">
				<a href='<?php echo $action_url; ?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='add-anchor add_button'>
				<div class="fbutton">
					<div>
						<span class="add"><?php echo $this->l('list_add'); ?> <?php echo $subject?></span>
					</div>
